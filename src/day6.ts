...
type FilterChildrenBy<Children, Filter> = Exclude<Children, Filter>;
...
// biome-ignore lint/complexity/noBannedTypes: this is originally from typeHero, don't want to modify
